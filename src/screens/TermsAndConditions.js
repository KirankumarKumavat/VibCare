...
class PrivacyPolicy extends Component {
    ...
    termsAndConditions = async () => {
        ...
        let response = await Request.get(`${constants.apiVersion}/termsandconditions`);
        this.setState({ loading: false })
        this.setState({ termsAndConditionData: response.data.data })
    }
        ...
        return (
            ...
            >
                <Header
                    ...
                    middleText={staticText.TermsAndConditions} />
                ...
                >
                    ...
                    {this.state.loading == false && <AutoHeightWebView
                        ...
                        source={{
                            ...
                            </style></head><body>${this.state.termsAndConditionData}</body>`,
                        }}
                        showsVerticalScrollIndicator={false}
                        scrollEnabled={true}
                    />
